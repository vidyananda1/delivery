...
/**
 * SliderImageSearch represents the model behind the search form of `app\models\SliderImage`.
 */
class SliderImageSearch extends SliderImage
{
    ...
    public function rules()
    {
        return [
            ...
            [['images', 'image_title', 'created_date', 'updated_date', 'record_status'], 'safe'],
        ];
    }
